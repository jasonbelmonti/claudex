...
- Copilot is runtime-backed and participates in default resolution after Codex and Claude. It still depends on local Copilot auth/entitlement, and several advanced event surfaces remain deferred.
